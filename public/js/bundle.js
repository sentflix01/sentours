...
},{}],"leafletMap.js":[function(require,module,exports) {
"use strict";
...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  if (leaflet) {
    var _locations = JSON.parse(leaflet.dataset.locations);
    var map = L.map('map', {
    ...
    _locations.forEach(function (loc) {
      ...
      // Marker with popup
      L.marker([lat, lng]).addTo(map).bindPopup("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>"), {
        autoClose: false,
        closeOnClick: false
      }).openPopup();
...
var login = exports.login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(email, password, button) {
    var originalText, res, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          // Store original button text
          originalText = button ? button.textContent : 'Login'; // Update button text to show loading state
          if (button) {
...
var getApiUrl = exports.getApiUrl = function getApiUrl(endpoint) {
  // Remove leading slash if present to avoid double slashes
  var cleanEndpoint = endpoint.startsWith('/') ? endpoint : "/".concat(endpoint);

  // Check if we're in local development (localhost or 127.0.0.1)
  var isLocalDev = window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1' || window.location.hostname === '';
  if (isLocalDev) {
    // Use relative URL for local development
    return cleanEndpoint;
  } else {
    // Use production API URL
    return "https://sentours.onrender.com".concat(cleanEndpoint);
  }
};
...
var signup = exports.signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(name, email, password, passwordConfirm, button) {
    var originalText, res, _err$response, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          // Store original button text
          originalText = button ? button.textContent : 'Sign Up'; // Update button text to show loading state
          if (button) {
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: (0, _config.getApiUrl)('/api/v1/users/signup'),
        ...
        case 2:
          ...
          if (res.data.status === 'success') {
            ...
            (0, _alerts.showAlert)('success', res.data.message || 'Signup successful! Please check your email to verify your account before logging in.');
            setTimeout(function () {
        ...
        case 3:
          ...
          (0, _alerts.showAlert)('error', ((_err$response = _t.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.message) || 'Signup failed. Please try again!');
        case 4:
          return _context.a(2);
      }
    }, _callee, null, [[1, 3]]);
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","./config":"config.js"}],"updateSettings.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* eslint-disable */
var stripe = Stripe('pk_test_51S42GVERuPMAxoh9QCy7LHhnapkB8kyUeqhrSZYapmKY1N1OmJJaFlseindxnsVL67hMb4sxmHIFwLvJhPKHW6n800PNeLZYqu');
...
if (signupForm) signupForm.addEventListener('submit', function (e) {
  ...
  (0, _signup.signup)(name, email, password, passwordConfirm, submitBtn);
});
if (loginForm) loginForm.addEventListener('submit', function (e) {
  ...
  var email = document.getElementById('email').value;
  var password = document.getElementById('password').value;
  (0, _login.login)(email, password, submitBtn);
});
...
window.addEventListener('DOMContentLoaded', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
  return _regenerator().w(function (_context3) {
    while (1) switch (_context3.n) {
      case 0:
        document.querySelectorAll('[data-tour-id]').forEach(/*#__PURE__*/function () {
          var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(el) {
            var tourId, commentsContainer, response, data, comment, reply, html, _t;
            return _regenerator().w(function (_context2) {
              while (1) switch (_context2.p = _context2.n) {
                case 0:
                  tourId = el.getAttribute('data-tour-id');
                  commentsContainer = document.getElementById("comments-container-".concat(tourId));
                ...
                case 1:
                  _context2.p = 1;
                  _context2.n = 2;
                  return fetch("/api/v1/tours/".concat(tourId, "/comments/default"));
                case 2:
                ...
                case 3:
                  ...
                  if (data.status === 'success' && data.data.comment) {
                    ...
                    reply = data.data.latestReply; // Render the comment
                    html = "<div class=\"comment-item\">\n          <div class=\"comment-header\">\n            <img class=\"comment-avatar\" src=\"/img/users/".concat(comment.user.photo || 'default.jpg', "\" alt=\"").concat(comment.user.name, "\">\n            <div class=\"comment-info\">\n              <span class=\"comment-author\">").concat(comment.user.name, "</span>\n              <span class=\"comment-time\">").concat(new Date(comment.createdAt).toLocaleString(), "</span>\n            </div>\n          </div>\n          <div class=\"comment-content\">\n            <p class=\"comment-text\">").concat(comment.text, "</p>\n            ").concat(comment.photo ? "<img class=\"comment-photo\" src=\"/img/comments/".concat(comment.photo, "\" alt=\"comment photo\">") : '', "\n          </div>");
                    if (reply) {
                      html += "<div class=\"comment-replies\">\n            <div class=\"comment-reply\">\n              <img class=\"reply-avatar\" src=\"/img/users/".concat(reply.user.photo || 'default.jpg', "\" alt=\"").concat(reply.user.name, "\">\n              <div class=\"reply-content\">\n                <span class=\"reply-author\">").concat(reply.user.name, "</span>\n                <span class=\"reply-text\">").concat(reply.text, "</span>\n                <span class=\"reply-time\">").concat(new Date(reply.createdAt).toLocaleString(), "</span>\n              </div>\n            </div>\n          </div>");
                    }
                    html += '</div>';
